...
<Carousel
  frame="browser"
  caption="Three ways to reach a page in this help center — try the arrows or the arrow keys."
  slides={[
    {src: '/img/help-center/search-docs.png', alt: 'The help center home with the navbar search box outlined in yellow.', caption: 'Step 1 — Search from anywhere with Ctrl+K.'},
    {src: '/img/help-center/navigate-sidebar.png', alt: 'A guide page with the left sidebar navigation outlined.', caption: 'Step 2 — Or browse the sidebar by section.'},
    {src: '/img/help-center/jump-to-section.png', alt: 'An API endpoint page with the on-page table of contents outlined in blue.', caption: 'Step 3 — On long pages, jump with the table of contents.'},
  ]}
/>
...
<Carousel
  ...
  slides={[
    {src: '/img/help-center/search-docs.png', alt: 'The help center home with the search box outlined in yellow.', caption: 'Step 1 — Search from anywhere with Ctrl+K.'},
    {src: '/img/help-center/navigate-sidebar.png', alt: 'A guide page with the sidebar outlined.', caption: 'Step 2 — Or browse the sidebar by section.'},
  ]}
/>
```
